...
namespace Pathfinding {
	...
	public class PointGraphEditor : GraphEditor {
		...
		public override void OnInspectorGUI (NavGraph target) {
			...
			graph.root = ObjectField(new GUIContent("PixelGame", "All childs of this object will be used as nodes, if it is not set, a tag search will be used instead (see below)"), graph.root, typeof(Transform), true, false) as Transform;
