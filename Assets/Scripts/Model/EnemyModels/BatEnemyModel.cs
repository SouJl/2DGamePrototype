...
namespace PixelGame.Model
{
    public class BatEnemyModel : AbstractEnemyModel
    {
        ...
        public BatEnemyModel(SpriteRenderer spriteRenderer, Collider2D collider2D, IMove movementModel, Transform muzzle) : base(spriteRenderer, collider2D, movementModel)
        {
            _muzzle = muzzle;
        }
