...
namespace PixelGame.Model.StateMachines
{
    ...
    {
        public BatEnemyIdleState(StateMachine stateMachine, SpriteAnimatorController animatorController, EnemyModel enemy) : base(stateMachine, animatorController, enemy)
        {
        }
